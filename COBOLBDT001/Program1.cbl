      ...
      *THIS PROGRAM READS A FILE AND CREATES A PAINT COST REPORT.
       ...
       FD      PRTOUT
               ...
               LINAGE IS 0 WITH FOOTING AT 56.
       ...
       01      WORK-AREA.
         ...
         05 C-PAINT-WALL-SQ-FT         PIC 999999999V99.
         05 C-GALLONS                  PIC 999999999V99.
         05 C-PAINT-COST               PIC 999999999V99.
         05 C-LABOR-COST               PIC 999999999V99.
         05 C-TOTAL-COST               PIC 999999999V99.
         05 C-GT-GALLONS               PIC 999999999V99    VALUE 0.
         05 C-GT-PAINT-COST            PIC 999999999V99    VALUE 0.
         05 C-GT-LABOR                 PIC 999999999V99    VALUE 0.
         05 C-GT-TTL                   PIC 999999999V99    VALUE 0.
       ...
       01 DETAIL-LINE.
         ...
         05 0-PAINT-EST-NO             PIC X(4).
         05 FILLER                     PIC X(7)    VALUE SPACES.
         05 0-PAINT-MM                 PIC 99.
         05 FILLER                     PIC X       VALUE '/'.
         05 0-PAINT-DD                 PIC 99.
         05 FILLER                     PIC X       VALUE '/'.
         05 0-PAINT-YY                 PIC 9(4).
         05 FILLER                     PIC X(7)    VALUE SPACES.
         05 0-PAINT-WALL-SQ-FT         PIC ZVZZZ.
         05 FILLER                     PIC X(7)    VALUE SPACES.
         05 0-PAINT-DOOR-SQ-FT         PIC ZZZ.
         05 FILLER                     PIC X(8)    VALUE SPACES.
         05 0-PAINT-TTL-SQ-FT          PIC ZVZZZ.
         05 FILLER                     PIC X(7)    VALUE SPACES.
         05 0-GAL-NEEDED               PIC ZZZ.99.
         05 FILLER                     PIC X(9)    VALUE SPACES.
         05 0-PAINT-PRICE-GAL          PIC ZZ.99.
         05 FILLER                     PIC X(6)    VALUE SPACES.
         05 0-PAINT-EST                PIC $ZZ,ZZZ.99.
         05 FILLER                     PIC X(7)    VALUE SPACES.
         05 0-LBR-EST                  PIC $ZZ,ZZZ.99.
         05 FILLER                     PIC X(6)    VALUE SPACES.
         05 0-TTL-EST                  PIC $ZZ,ZZZ.99.
       ...
       01 TTL-LINE. 
        ...
        05 0-ECTR                      PIC ZZ9.
        05 FILLER                      PIC X(7)      VALUE SPACES.
        05 0-TTL-GAL                   PIC ZZ,ZZZ.99.
        05 FILLER                      PIC X(15)     VALUE SPACES.
        05 0-TTL-PAINT-EST             PIC $$,$$$,$$$.99.
        05 FILLER                      PIC X(4)      VALUE SPACES.
        05 0-TTL-LBR-EST               PIC $$,$$$,$$$.99.
       ...
       2100-CALCS.
           ...
           ADD C-GALLONS TO C-GT-GALLONS GIVING C-GT-GALLONS.
